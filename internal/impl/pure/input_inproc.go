...
func inprocInputSpec() *service.ConfigSpec {
	return service.NewConfigSpec().
		...
		Categories("Utility").
		Description(`
Directly connect to an output within a Bento process by referencing it by a chosen ID. This allows you to hook up isolated streams whilst running Bento in ` + "xref:guides:streams_mode/about.adoc[streams mode]" + `, it is NOT recommended that you connect the inputs of a stream with an output of the same stream, as feedback loops can lead to deadlocks in your message flow.
