...
This ecosystem is delicate as WASM doesn't have a single clearly defined way to pass strings back and forth between the host and the module. In order to remedy this we're gradually working on introducing libraries and examples for multiple languages which can be found in https://github.com/warpstreamlabs/bento/tree/main/public/wasm/README.md[the codebase].
...
func (p *wazeroAllocProcessor) newModule() (mod *moduleRunner, err error) {
	...
	builder := r.NewHostModuleBuilder("bento_wasm")
