...
func ConfigSpec() docs.FieldSpecs {
	return docs.FieldSpecs{
		...
		docs.FieldBloblang(
			"mapping", "A xref:guides:bloblang/about.adoc[Bloblang] mapping that translates the fields of the template into a valid Bento configuration for the target component type.",
		),
